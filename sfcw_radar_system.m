...
%}
%{
[R01, d_01, R0, R1, d_R0, d_R1, x_tick, y_tick, z_tick, x_grid, y_grid, z_grid, index_mat, phase_mat] =...
    kir_calculate_3d_image_grid(fl, dr, antenna_pos, image_info, ifft_number);%Kirchhoff forward
%}
%{
    [R01, d_01, R0, R1, d_R0, d_R1, x_tick, y_tick, z_tick, x_grid, y_grid, z_grid, index_mat, phase_mat] =...
    kir_calculate_3d_image_grid(fl, dr, antenna_pos, image_info,
    ifft_number);%Kirchhoff backward
    %}
...
for i=1:frame_number
    ...
    [bp_sum, bp_sum_cf] = back_projection_3d(...
        ...
        %}
    %[bp_sum, bp_sum_cf] = kirchhoff_3d(R01, d_01, R0, R1, d_R0, d_R1, range_profiles, index_mat, phase_mat);%Kirchhoff forward
    %[bp_sum, bp_sum_cf] = kirchhoff_3d(R01, d_01, R0, R1, d_R0, d_R1, range_profiles, index_mat, phase_mat);%Kirchhoff backward
